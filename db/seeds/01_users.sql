...
INSERT INTO quizzes (id, owner_id, quiz_name, level, public) VALUES ('5', '3', 'Marvel2 Normal', 'f', 'f');
INSERT INTO quizzes (id, owner_id, quiz_name, level, public) VALUES ('6', '3', 'Videogames normal', 'f', 't');
INSERT INTO quizzes (id, owner_id, quiz_name, level, public) VALUES ('7', '3', 'Videogames Hard', 't', 't');
...
INSERT INTO questions (quiz_id, question, choice_a, choice_b, choice_c, choice_d, answer) VALUES ('4', 'Okay, if you are a fan of the Tekken series, this should be the easiest question so far. What is the name of the company behind Tekken?', 'Namco', 'Ubisoft', 'Midway', 'Capcom', 'a');
...
INSERT INTO questions (quiz_id, question, choice_a, choice_b, choice_c, choice_d, answer)
VALUES ('5', 'What comic first introduced the Infinite Stones?', 'Marvel Premiere #1', 'Marvel Team-Up #55', 'The Infinite Gauntlet #1', 'Guardians of the Galaxy #1', 'a' );
INSERT INTO questions (quiz_id, question, choice_a, choice_b, choice_c, choice_d, answer)
VALUES ('5', 'What year was Captain America born?', '1915', '1917', '1920', '1922', 'c'  );
INSERT INTO questions (quiz_id, question, choice_a, choice_b, choice_c, choice_d, answer)
VALUES ('5', 'Which character shares their power origin with Dr.Strang and the Bands of Cyttorack?', 'Wanda Maximoff', 'Brother Voodoo', 'Juggernaut', 'High Evolutionary', 'c');
INSERT INTO questions (quiz_id, question, choice_a, choice_b, choice_c, choice_d, answer)
VALUES ('5', 'What animal shares the powers of THOR?', 'dog', 'frog', 'cat', 'pig', 'b');
INSERT INTO questions (quiz_id, question, choice_a, choice_b, choice_c, choice_d, answer)
VALUES ('5', 'What year did Thors sister Angela debut in comics?', '1975', '1993', '2002', '2020', 'b');
INSERT INTO questions (quiz_id, question, choice_a, choice_b, choice_c, choice_d, answer)
VALUES ('5', 'Who is the 3rd herald of Galactus?', 'Morg', 'Nova', 'Air Walker', 'Silver Surfer', 'a' );
INSERT INTO questions (quiz_id, question, choice_a, choice_b, choice_c, choice_d, answer)
VALUES ('5', 'What is the name of Charles Xaviers sister?', 'La Landra', 'Moira', 'Jean', 'Cassandra', 'd');
INSERT INTO questions (quiz_id, question, choice_a, choice_b, choice_c, choice_d, answer)
VALUES ('5', 'Which character didnt wear the Iron Man armor?', 'Aunt May', 'Dr. Doom', 'Reed Richards', 'Mary Jane Watson', 'c');
INSERT INTO questions (quiz_id, question, choice_a, choice_b, choice_c, choice_d, answer)
VALUES ('5', 'Which character wasnt part of a Sinister 6?', 'Prowler', 'Venom', 'Carnage', 'Grim Reaper', 'b');
INSERT INTO questions (quiz_id, question, choice_a, choice_b, choice_c, choice_d, answer)
VALUES ('5', 'Who didnt kill the Marvel Universe?', 'Wolverine', 'Dead Pool', 'The Punisher', 'Blade', 'd');
INSERT INTO questions (quiz_id, question, choice_a, choice_b, choice_c, choice_d, answer)
VALUES ('5', 'Who wasnt a Sorcerer Supreme?', 'Wanda Maximoff', 'Loki', 'Illyana Rasputina', 'Xhoohx', 'a');


--questions for Videogames normal
INSERT INTO questions (quiz_id, question, choice_a, choice_b, choice_c, choice_d, answer)
VALUES ('6', 'Who is the creator of Mario?', 'Shigeru Miyamoto', 'Yuji Naka', 'Eiji Aonuma', 'Akira Kitamura', 'a');
INSERT INTO questions (quiz_id, question, choice_a, choice_b, choice_c, choice_d, answer)
VALUES ('6', 'What was Marios original name?', 'Shoot man', 'Luigi', 'Running Man', 'Jump Man', 'd');
INSERT INTO questions (quiz_id, question, choice_a, choice_b, choice_c, choice_d, answer)
VALUES ('6', 'How many Tekken games came out on the PSX?', '1', '3', '5', '7', 'b');
INSERT INTO questions (quiz_id, question, choice_a, choice_b, choice_c, choice_d, answer)
VALUES ('6', 'Who is the Mascot for the XBOX?', 'Mario', 'Sonic', 'Master Chief', 'Crash', 'c');
INSERT INTO questions (quiz_id, question, choice_a, choice_b, choice_c, choice_d, answer)
VALUES ('6', 'How many Tekken games came out on the PSX?', '1', '3', '5', '7', 'b');
INSERT INTO questions (quiz_id, question, choice_a, choice_b, choice_c, choice_d, answer)
VALUES ('6', 'Who is the Mascot for the SEGA?', 'Sonic', 'Mario', 'Master Chief', 'Crash', 'a');
INSERT INTO questions (quiz_id, question, choice_a, choice_b, choice_c, choice_d, answer)
VALUES ('6', 'Who is the Mascot for Namco?', 'Mario', 'Sonic', 'Pac-Man', 'Crash', 'c');
INSERT INTO questions (quiz_id, question, choice_a, choice_b, choice_c, choice_d, answer)
VALUES ('6', 'What is the worlds highest selling game?', 'Mario Kart', 'Minecraft', 'Wii-Sports', 'Animal Crossing', 'b');
INSERT INTO questions (quiz_id, question, choice_a, choice_b, choice_c, choice_d, answer)
VALUES ('6', 'Which one isnt a Nintendo character?', 'Mario', 'Sonic', 'Captain Falcon', 'Little Mac', 'b');
INSERT INTO questions (quiz_id, question, choice_a, choice_b, choice_c, choice_d, answer)
VALUES ('6', 'What famous RPG is Squaresoft known for', 'Dragon Quest', 'Tales Series', 'Earthbound', 'Final Fantasy', 'd');


--questions for Videogames hard
INSERT INTO questions (quiz_id, question, choice_a, choice_b, choice_c, choice_d, answer)
VALUES ('7', 'Which one is not a Mario game?', 'Hotel Mario', 'Mario Family', 'Mario Wacky Worlds', 'NBA Street V3', 'c');
INSERT INTO questions (quiz_id, question, choice_a, choice_b, choice_c, choice_d, answer)
VALUES ('7', 'Which one is not a Zelda game?', 'Tetras Trackers', 'Freshly Picked Tingles Rosy Rupeelan', 'Zelda Spirit Tracks', 'BS Zelda', 'a');
INSERT INTO questions (quiz_id, question, choice_a, choice_b, choice_c, choice_d, answer)
VALUES ('7', 'Which character wasnt in the Tekken series?', 'Spawn', 'Gon', 'Yoda', 'Kratos', 'd');
INSERT INTO questions (quiz_id, question, choice_a, choice_b, choice_c, choice_d, answer)
VALUES ('7', 'Which generation does Pokemon Soul Silver belong to?', 'Gen 2', 'Gen 3', 'Gen 4', 'Gen 5', 'c');
INSERT INTO questions (quiz_id, question, choice_a, choice_b, choice_c, choice_d, answer)
VALUES ('7', 'Who designed the original Phantasy Star?', 'Yuji Naka', 'Kotaro Hayashida', 'Rieko Kodama', 'Tokuhiko Uwabo', 'b');
INSERT INTO questions (quiz_id, question, choice_a, choice_b, choice_c, choice_d, answer)
VALUES ('7', 'What were the estimated life time sales of the Sega Saturn', '4.24 million', '7.56 million', '8.76 million', '9.26 million', 'd');
INSERT INTO questions (quiz_id, question, choice_a, choice_b, choice_c, choice_d, answer)
VALUES ('7', 'What were the estimated life time sales of the Sony PSX?', '82.52 million', '93.56 million', '102.49 million', '110.27 million', 'c');
INSERT INTO questions (quiz_id, question, choice_a, choice_b, choice_c, choice_d, answer)
VALUES ('7', 'What were the estimated life time sales of the Nintendo 64?', '18.92 million', '32.93 million', '45.98 million', '54.12 million', 'b');
INSERT INTO questions (quiz_id, question, choice_a, choice_b, choice_c, choice_d, answer)
VALUES ('7', 'What was the orginal name for RARE limited?', 'Ultimate Play the Game', 'Stamper Bros Inc.', 'Ultra Games', 'British Games', 'a');
INSERT INTO questions (quiz_id, question, choice_a, choice_b, choice_c, choice_d, answer)
VALUES ('7', 'What was the highest selling Tekken game?', 'Tekken 2', 'Tekken 3', 'Tekken 5', 'Tekken 7', 'b');
